...
const ProjectCard: React.FC<ProjectCardProps> = ({ data }) => {
    ...
    return (
        <div className="w-full desktop:w-[280px] h-[220px] flex flex-col px-2 py-2 gap-2">
            <img className="w-[100%] h-[80%] object-cover rounded-md" src={data.image} alt={data.title} />
